...
Feature: 租客联系人
  ...
  @CreamsAPPIOS  @MAR-2249 @MAR-2219  @MAR-2256 @wangshengwei
  Scenario Outline: 新建租客联系人，填写必填项
    ...
    And 点击新建租客联系人页面的保存按钮
    Then 租客联系人搜索框页上存在一个姓名和公司为 "<姓名和公司>"的租客,租客新建成功
    And 电话和邮箱显示正确 "<姓名和公司>" "<电话和公司>"



    Examples:
      |         邮箱       |   密码   |      姓名   |    电话      | 姓名和公司    |   电话和公司   |
      |xypeng@91souban.com |Pexy6666 |auto租客联系人| 18158885551 |auto租客联系人，|18158885551 /|