...
Feature: 客户管理
  ...
  @CreamsAPPIOS @MAR-2219  @MAR-2256   @wangshengwei
  ...
  #查看客户详情
    ...
    And ios客户详情的租客信息显示正确 "<租客联系人>" "<需求面积>" "<租客状态>" "<来访渠道>" "<行业>" "<来访时间>" "<渠道联系人>" "<商圈>"
    And 客户详情的房源信息显示正确 "<楼宇>"
    And ios客户详情的租客当前信息显示正确 "<当前地址>" "<当前面积>" "<当前租金>" "<期望价格>"
  ...
  #查看操作记录
    ...
    Examples: 
      ...
      |xypeng@91souban.com|Pexy6666 |全部自动化测试|软件开发|silence     |silence，杭州匠人网络|     1     |   100    | 初次接触 |自由经纪人 |  自动化测试账号 |自动化测试账号，自动化测试公司|自动化测试 |自动化测试（不要动）|  滨江区  |杭州市/滨江区/彩虹城商圈|      1     |  5       |  杭州 | 1000 | 500 |  小破孩  | 1-100m²|自动化测试（不要动）|  今天  | 0%    |1-100m²|1000m²|500元/月|1-5元/m²·天|创建客户需求。客户状态：初次接触|
      

  @CreamsAPPIOS  @MAR-2252  @MAR-2253  @MAR-2255   @wangshengwei
  ...
  #检查备注
    ...
    When 点击客户详情页上的操作按钮
    And 点击操作列表中的备注
    Then 备注列表中存在一条备注姓名为 "<备注姓名>"的备注
    And 备注的内容显示正确 "<备注姓名>" "<备注>"
    
    Examples: 
      |         邮箱       |   密码  |租客姓名  |租客状态 | 来访渠道 |  备注   |       楼宇      |    租赁顾问  | 需求面积段 |      意向房源   |来访时间  |备注姓名| 
      |xypeng@91souban.com|Pexy6666|必填自动化测试| 初次接触|自由经纪人|自动化测试 |自动化测试（不要动）| 小破孩|    暂无   |自动化测试（不要动）|  今天  |小破孩（本人）|
      
      
  @CreamsAPPIOS  @MAR-2238   @wangshengwei
  Scenario Outline: 客户管理通过客户姓名搜索客户
    ...
    Examples: 
     ...
     | xypeng@91souban.com| Pexy6666 | auto客户搜索 | 初次接触|小破孩 |2018/02/25|300-400m²|公司经纪人|自动化测试（不要动）（1房源 \| 333m²）|
     
     
     
  @CreamsAPPIOS  @MAR-2255 @MAR-7589 @MAR-7590  @wangshengwei
  Scenario Outline: 新增、编辑、删除备注
   ...
   #编辑备注
    ...
    Examples: 
     ...
     | xypeng@91souban.com |Pexy6666  | auto客户搜索 |小破孩（本人）|测试新增备注|编辑备注|
     
     
   
  @CreamsAPPIOS  @MAR-2252  @wangshengwei
  ...
  Scenario Outline: 筛选今日、昨日、本周、本月的用户列表
    ...
    Examples:
      | 邮箱                | 密码     |快捷筛选|
      | xypeng@91souban.com |Pexy6666 | 今天  |
