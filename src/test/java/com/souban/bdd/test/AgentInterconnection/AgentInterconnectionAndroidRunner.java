package com.souban.bdd.test.AgentInterconnection;
...
@CucumberOptions(features = "src/test/resources/features", glue = { "com.souban.bdd.steps" }, plugin = { "pretty",
		...
		"junit:target/cucumberReport/junit/cucumber-report.xml" }, tags = { "@AgentInterconnectionAndroid" })

public class AgentInterconnectionAndroidRunner {
