...
public class APIDriver {
	...
	public Header getUserHeader() {
		return userHeader;
	}

	public void setUserHeader(String AccessToken) {
		this.userHeader = new Header("Authorization", AccessToken);
	}
	...
	public void setAdminHeader(String AdminAccessToken) {
		this.adminHeader = new Header("Authorization", AdminAccessToken);
	}
